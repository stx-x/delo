    ...
    >
        <div class="w-full max-w-4xl">
            ...
            <div class="text-center mb-10">
                <h1
                    class="flex items-center justify-center gap-3 text-6xl font-black tracking-tight text-center relative"
                >
                    <div class="brand-wrapper">
                        <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700 hover:from-blue-700 hover:via-blue-500 hover:to-blue-800 transition-all duration-500 brand-text"
                            >Delo</span
                        >
                        <span class="text-slate-300 mx-1 brand-dot">·</span>
                        <span
                            class="font-art text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:from-blue-600 hover:via-blue-700 hover:to-blue-800 transition-all duration-500 brand-text-cn"
                        >
                            去若
                        </span>
                    </div>
                ...
                <p
                    class="text-slate-500 mt-6 text-lg font-medium tracking-wide brand-slogan"
                >
                    快速识别并管理重复图片，让您的相册<span
                ...
                >
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <button
                            ...
                            class="px-3.5 py-2 text-sm bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg transition-all flex items-center gap-1.5 hover:shadow-sm transform hover:-translate-y-0.5 active:translate-y-0"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                    ...
                    <div class="mb-6">
                        ...
                        <div
                            class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-2"
                        >
                            <div
                                ...
                                class="flex items-start p-4 rounded-lg border cursor-pointer transition-all duration-300 transform hover:scale-102 hover:shadow-md group"
                                :class="
                                    algorithm === algo.id
                ...
                >
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex gap-2">
                            <button
                                @click="openFolderDialog"
                                class="px-3 py-1.5 text-sm bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg transition-all flex items-center"
                                :disabled="loading"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <button
                                ...
                                class="px-3 py-1.5 text-sm bg-red-50 hover:bg-red-100 text-red-600 rounded-lg transition-all flex items-center"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-4 w-4 mr-1"
                    ...
                    <!-- 文件夹列表 -->
                    <div
                        class="bg-slate-50 rounded-lg border border-slate-200 max-h-[200px] overflow-y-auto shadow-inner"
                    >
                        <ul class="divide-y divide-slate-200">
                            <li
                                v-for="(folder, index) in selectedFolders"
                                :key="index"
                                class="px-4 py-3.5 flex justify-between items-center hover:bg-blue-50 transition-all duration-300 group"
                            >
                                <div class="flex items-center flex-1 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <div class="flex items-center">
                                            <span
                                                class="truncate max-w-lg text-slate-700 font-medium group-hover:text-blue-700 transition-colors"
                                                :title="folder"
                                                >{{ formatPath(folder) }}</span
                                            >
                                            <span
                                                class="ml-2 text-xs px-1.5 py-0.5 bg-slate-200 text-slate-600 rounded group-hover:bg-blue-200 group-hover:text-blue-700 transition-colors"
                                            >
                                                文件夹 {{ index + 1 }}
                                            </span>
                                        </div>
                                ...
                                <button
                                    ...
                                    class="ml-3 w-8 h-8 flex items-center justify-center rounded-full text-slate-400 hover:text-white hover:bg-red-500 transition-all group-hover:bg-red-100"
                                    title="移除此文件夹"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
